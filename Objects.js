...
Person1 = new Person("Padma","Sri",99,['java','c#'],"01/01/1998",{city:"Bangalore",pincode:67856},"false","AnalystA4");
Person2 = new Person("Sowmi","Geetha",3,["c++","c#"],"02/02/1998",{city:"Kurnool",pincode:518002},"false","AnalystA4");
...
Mahesh = new Person("Mahesh","Srinivas",99,['java','c#'],"01/01/1969",{city:"Bangalore",pincode:67856},"false","AnalystA4");
Tony = new Person("Tony",55,["html","css"],"05/06/1975","false","JrAnalyst");
Arvind = new Person("Arvind",10,"01/01/2005","false","film");
...
var obj1 = new Account(321345,"Sowmi",65536);
console.log(obj1);
...
var objSavings = new Savings("true",98765,"Valli",546776); //creating Savings object
console.log(objSavings);
console.log(objSavings.withdraw(500));
console.log(objSavings.getCurrentBalance());

var objCurrent = new Current(550,9876543,"Padma",5467878); //creating Current object
